...
var getSpendingForGraph = exports.getSpendingForGraph = function(userId, tripId, range, categories, callback) {
    var baseCurrency;
    var startDate;
    var endDate;
    var data;
    ...
    tripController.getUserIdForTrip(tripId, function(err, userIdForTrip) {
        ...
        async.series([
            ...
            function(cb) {
                ...
                cashQuery.getSpendingForRange(tripId, startDate, endDate, categories, function(err, results) {
                    if(err) {
                        return cb(err);
                    }
                    data = results;
